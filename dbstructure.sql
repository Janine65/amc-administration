...
--
-- Host: localhost    Database: amcmitglieder
-- ------------------------------------------------------
...
CREATE TABLE `adressen` (
  ...
  `land` varchar(45) COLLATE latin1_german1_ci NOT NULL DEFAULT 'CH',
  `telefon_p` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `telefon_g` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  ...
  `arbeitgeber` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  ...
  `fullname` varchar(500) COLLATE latin1_german1_ci GENERATED ALWAYS AS (concat_ws(_latin1' ',`vorname`,`name`)) VIRTUAL,
  PRIMARY KEY (`id`),
  ...
  KEY `NAME` (`name`),
  KEY `PLZ` (`plz`)
) ENGINE=MyISAM AUTO_INCREMENT=260 DEFAULT CHARSET=latin1 COLLATE=latin1_german1_ci;
...
CREATE TABLE `anlaesse` (
  ...
  `longname` varchar(500) CHARACTER SET latin1 COLLATE latin1_swedish_ci GENERATED ALWAYS AS (concat_ws(_latin1' ',date_format(`Datum`,_utf8mb4'%d.%m.%Y'),`Name`)) VIRTUAL,
  PRIMARY KEY (`id`),
