...
wxAMC.moduleClasses.Contacts = class {
  ...
  getUIConfig() {
    ...
    return {
      winLabel : "Contacts", winIcon : "webix_icon mdi mdi-contacts",
                ...
                { header : "Personal",
                  body : {
                    ...
                    elementsConfig : {
                      ...
                      on : {
                        onChange : wxAMC.modules.Contacts.validateFormsOnChange.bind(this)
                      }
                    },
                    elements : [
            ...
            { view : "toolbar",
              cols : [
                ...
                { id : "moduleContacts-deleteButton", view : "button",
                  ...
                  click : () => { wxAMC.deleteHandler("Contacts"); }
                },
                { },
  ...
  refreshData() {
    ...
    // create it now.
    const dataItems = wxAMC.getModuleData("Contacts");
    ...
    // alphabetical order.
    wxAMC.sortArray(itemsAsArray, "lastName", "A");
