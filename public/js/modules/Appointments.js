...
wxAMC.registeredModules.push("Appointments");


wxAMC.moduleClasses.Appointments = class {
  ...
  getUIConfig() {
    ...
    return {
      winWidth : 800, winHeight : 600, winLabel : "Appointments", winIcon : "webix_icon mdi mdi-calendar",
  ...
  newHandler() {
    ...
    wxAMC.modules.Appointments.isEditingExisting = false;
    wxAMC.modules.Appointments.editingID = new Date().getTime();
  ...
  editExisting(inID) {
    ...
    wxAMC.modules.Appointments.isEditingExisting = true;
    wxAMC.modules.Appointments.editingID = inID;
  ...
  refreshData() {
    ...
    const dataItems = wxAMC.getModuleData("Appointments");
    wxAMC.modules.Appointments.currentData = { };
    for (const key in dataItems) {
      if (dataItems.hasOwnProperty(key)) {
        const item = dataItems[key];
        wxAMC.modules.Appointments.currentData[new Date(item.when).setHours(0, 0, 0, 0)] =
          item;
      }
    }
  ...
  dayTemplate(inDate) {
    ...
    const appointment = wxAMC.modules.Appointments.currentData[thisDate];
  ...
  selectDateHandler(inDate) {
    ...
    const appointments = wxAMC.getModuleData("Appointments");
      ...
      body : function() {
        ...
        // If there is, show them as a list.
          ...
          return {
            ...
            template : "#subject#", click : wxAMC.modules.Appointments.editExisting,
          };
        }
      }()
    }).show();
  ...
  dayAtAGlance() {
    ...
    let dataItems = wxAMC.getModuleData("Appointments");
