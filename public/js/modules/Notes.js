...
wxAMC.registeredModules.push("Notes");


wxAMC.moduleClasses.Notes = class {
  ...
  getUIConfig() {
    ...
    return {
      winLabel : "Notes", winIcon : "webix_icon mdi mdi-note",
              ...
              type : {
                templateStart :
                  `<div style="${cssListItem}background-color:#color#;"
                   onClick="wxAMC.modules.Notes.editExisting('#id#');">`,
                template :
  ...
  refreshData() {
    ...
    // create it now.
    const dataItems = wxAMC.getModuleData("Notes");
    ...
    // be on the top.
    wxAMC.sortArray(itemsAsArray, "id", "D");
